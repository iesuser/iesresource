...
// put here the correct path to "../../../../block/mysqlajaxtableeditor/js/jscalendar/calendar.php"; don't move the file
// "../../../../block/mysqlajaxtableeditor/js/jscalendar/calendar.php" -- I think it's best if you leave it inside the
