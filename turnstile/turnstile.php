          ...
          <table class="table" id="filter_table" style="max-width:750px; border:#CCC solid 1px;" border="0" cellspacing="0">
              ...
              <tr >
                ...
                <td class="rightDottedBorder">
    				    <?php mysql_select_db($dbStaff,$db);	//მონაცემთა ბაზის გადართვა?>
                  ...
                  while($row = mysql_fetch_array($table))
                  {
                   ...
                   <option value="<?php echo $dep_id;?>"  <?php if($ganyofileba == $name) {echo "selected='selected'";}?>><?php echo $name;?></option>
            ...
            <td>
              ...
              <tr>
                ...
                <td class="rightDottedBorder">
                  ...
                  <option value=""></option>
                  <?php 
                    $staff_result = mysql_query("SELECT `id`, `first_name`, `last_name` FROM `staff` ORDER BY `first_name` ASC",$db); 
